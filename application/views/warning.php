<div class="container"><br>
	...
	<p>Halaman tidak bisa diakses karena akun Anda tidak berhak membuka halaman ini.<br>
	Halaman hanya bisa diakses oleh akun tertentu saja. <br><br>
	<b>Saran:</b><br>
	Silakan kembali ke menu utama atau akses dengan akun yang memiliki hak akses.</p>
	<hr>
	<a href="<?php echo base_url('admin/menu'); ?>" class="btn btn-default">Kembali ke Beranda</a>
</div>