<div class="container"><br>
	...
	<p>
	Halaman tidak bisa diakses karena pemungutan suara belum dibuka oleh panitia. <br>
	Halaman hanya bisa diakses pada waktu yang telah ditentukan. <br><br>
	<b>Saran:</b><br>
	Silakan coba kembali saat pemungutan suara dibuka, atau pada tanggal dan jam yang telah ditentukan. <br>
	<?php 
	echo "Voting dibuka pada tanggal <b>";
	echo $this->Pemilwa_model->pengaturan('tanggal_mulai');
	echo "</b> sampai <b>";
	echo $this->Pemilwa_model->pengaturan('tanggal_akhir');
	echo "</b> pada pukul <b>";
	...
	<a href="<?php echo base_url('vote/index/1'); ?>" class="btn btn-default">Skip</a><br>
